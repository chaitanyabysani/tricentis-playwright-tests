...
export class CameraPhotoPage {
  ...
  // Price filters
  readonly priceFilterUnder500: Locator;
  readonly priceFilterOver500: Locator;
  ...
  constructor(page: Page) {
    ...
    // Price filters
    this.priceFilterUnder500 = page.getByRole('link', { name: 'Under 500.00' });
    this.priceFilterOver500 = page.getByRole('link', { name: 'Over 500.00' });
  ...
  async filterByPriceUnder500() {
    await this.priceFilterUnder500.click();
  }

  async filterByPriceOver500() {
    await this.priceFilterOver500.click();
  }
